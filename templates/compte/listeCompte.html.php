        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden min-h-[calc(100vh-8rem)] flex flex-col">
            ...
            <div class="p-8 flex-1">
                                    ...
                                    <tr class="hover:bg-orange-50 transition-all duration-300 hover:shadow-md">
                                        <td class="px-8 py-6 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center mr-4 shadow-sm">
                                                    <i class="fas fa-mobile-alt text-orange-600 text-lg"></i>
                                                </div>
                                                <span class="text-gray-900 font-semibold text-lg"><?= $compte['numerotel'] ?></span>
                                            </div>
                                        </td>
                                        <td class="px-8 py-6 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <span class="text-2xl font-bold text-green-600 mr-2"><?= $compte['solde'] ?></span>
                                        ...
                                        <td class="px-8 py-6 whitespace-nowrap">
                                            <?php if($compte['principal'] ?? false): ?>
                                                <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-yellow-100 text-yellow-800 shadow-sm">
                                        ...
                                        <td class="px-8 py-6 whitespace-nowrap">
                                            <?php if(!($compte['principal'] ?? false)): ?>
                                                <button class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg flex items-center text-sm">
                ...
                <div id="no-comptes" class="hidden text-center py-16">
                    <div class="w-24 h-24 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
            ...
            <div class="bg-gray-100 px-8 py-6 border-t border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <button class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-xl flex items-center">
