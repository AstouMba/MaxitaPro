        ...
        <div class="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md">
            ...
            <form class="space-y-6" action="/auth" method="post">
                ...
                <div>
                    ...
                    <input type="login" name="login" value="<?= htmlspecialchars($_POST['login'] ?? '') ?>"
                        placeholder="">
                ...
                <div>
                    ...
                    <input type="password" name="password" <?php if (!empty($errors['password'])): ?> 
                            class="mt-1 text-red-600 text-sm"><?= htmlspecialchars($errors['password']) ?></p>
                    <?php endif; ?>
                </div>
