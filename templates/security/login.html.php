...
<div class="flex w-full max-w-6xl mx-auto">
    <!-- Image -->
    <div class="hidden md:flex flex-1 items-center justify-center p-8 rounded-3xl">
        <img src="/assets/Banknote-pana (3).png" alt="Illustration connexion" class="max-w-full h-auto">
    </div>
